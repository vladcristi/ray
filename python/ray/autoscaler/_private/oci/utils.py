...
#     for vm_shape in vm_shapes:
#         if vm_shape.shape == "VM.Standard.B1.1":
#             shape = vm_shape
...
def create_instance_with_network(instance_type, compartment_id, cidr_block, public_key_path):

    with open(os.path.expandvars(os.path.expanduser(public_key_path)), mode='r') as file:
    ...
    image = get_image(compute_client, compartment_id, instance_type)
    ...
    launch_instance_details = get_launch_instance_details(
        compartment_id, availability_domain, instance_type, image, subnet, ssh_public_key
    )
...
#     compartment_id = "ocid1.compartment.oc1..aaaaaaaa3l2tyis5kuaheidnqmr34vff6odi7co5pzfv2c5sifabbiegnb5q"
#     cidr_block = "10.0.0.0/16"
#     ssh_public_key = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEWqxhVnQD/VtbOBTO3ofNhQk3z9v1rxa+Fnra2wv6Hy gvlad@gvlad-mac"
